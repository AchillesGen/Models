...
FRS2 = Lorentz(name = 'FRS2',
               spins = [ 2, 4, 1 ],
               structure = '-(Epsilon(2,-1,-2,-3)*P(-2,2)*P(-1,3)*Gamma5(-4,1)*Gamma(-3,2,-4))')
...
FRV2 = Lorentz(name = 'FRV2',
               spins = [ 2, 4, 3 ],
               structure = '-(Epsilon(2,3,-1,-2)*P(-1,2)*Gamma5(-3,1)*Gamma(-2,2,-3))')

FRV3 = Lorentz(name = 'FRV3',
               spins = [ 2, 4, 3 ],
               structure = '-2*Epsilon(2,3,-1,-2)*P(-2,3)*P(-1,2)*Identity(2,1)')
...
FRV5 = Lorentz(name = 'FRV5',
               spins = [ 2, 4, 3 ],
               structure = 'P(2,3)*P(3,2)*Gamma5(2,1) - P(-1,2)*P(-1,3)*Gamma5(2,1)*Metric(2,3)')
...
RFS2 = Lorentz(name = 'RFS2',
               spins = [ 4, 2, 1 ],
               structure = '-(Epsilon(1,-1,-2,-3)*P(-2,1)*P(-1,3)*Gamma5(-4,1)*Gamma(-3,2,-4))')
...
RFV2 = Lorentz(name = 'RFV2',
               spins = [ 4, 2, 3 ],
               structure = '-(Epsilon(1,3,-1,-2)*P(-1,1)*Gamma5(-3,1)*Gamma(-2,2,-3))')

RFV3 = Lorentz(name = 'RFV3',
               spins = [ 4, 2, 3 ],
               structure = '-2*Epsilon(1,3,-1,-2)*P(-2,3)*P(-1,1)*Identity(2,1)')
...
RFV5 = Lorentz(name = 'RFV5',
               spins = [ 4, 2, 3 ],
               structure = 'P(1,3)*P(3,1)*Gamma5(2,1) - P(-1,1)*P(-1,3)*Gamma5(2,1)*Metric(1,3)')
